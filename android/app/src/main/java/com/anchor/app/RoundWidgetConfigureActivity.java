...
public class RoundWidgetConfigureActivity extends Activity {
    ...
    public static final String KEY_ACTION_PREFIX = "action_";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_open_app).setOnClickListener(v -> finishWithAction(ACTION_OPEN_APP));
        findViewById(R.id.btn_open_clip).setOnClickListener(v -> finishWithAction(ACTION_OPEN_CLIP));
    }

    private void finishWithAction(String action) {
        getSharedPreferences(PREFS, MODE_PRIVATE)
            .edit().putString(KEY_ACTION_PREFIX + appWidgetId, action).apply();
